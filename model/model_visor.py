...
from model.losses import LossComputer, iou_hooks_mo, iou_hooks_so, CombineLossComputer
from util.log_integrator import Integrator
from util.image_saver import pool_pairs

class STCNVISORModel:
    """
    ...
    def __init__(self, para, save_path='./saves'):
        ...
        self.STCN = STCN(single_object=False).cuda() # VISOR and EgoHOS use multi-object
        ...
        elif self.loss == 'combine':
            self.loss_computer = CombineLossComputer() # later change to CombineLossComputer for boundary
